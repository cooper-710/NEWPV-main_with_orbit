...
export function initScene() {
  ...
  scene.fog = new THREE.Fog(0x000000, 85, 170);
  ...
  const fill = new THREE.HemisphereLight(0xffffff, 0x000000, 0.4);
  scene.add(fill);

  const plateLight = new THREE.PointLight(0xffffff, 1.0, 120);
  plateLight.position.set(0, 3.0, -60.5);
  scene.add(plateLight);

  // Orange accent lighting
  const accentLight = new THREE.PointLight(0xff6600, 0.3, 100);
  accentLight.position.set(0, 8, -30);
